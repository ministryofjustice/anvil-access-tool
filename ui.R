        ...
        fluidRow(
          column(width = 4, #class = "class_selections",
                 ...
                 fluidRow(#class = "class_top_banner",
                   div(class = "class_mainTitle", "MoJ Prison Intelligence tools access request form to reinstate access")
                 ),
                 div(class = "class_selections",
                     fluidRow(
                       div(class = "class_intro",
                           HTML("<p><div style='color:red'>To reinstate your access to the MoJ prison intelligence tools,
                              please enter your details in the fields below and click submit.</div></p>
                                <p>If you have any issues submitting this form,
                              please contact MISST@justice.gov.uk</p>"))
                     ),
