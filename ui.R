...
shinyUI(
  shiny::fluidPage(
    ...
    div(style = "background-color:WhiteSmoke;",
        ...
        ## Main page
        fluidRow(div(class = "class_intro",
                           HTML("<p><div style='color:red'>THIS PAGE IS NO LONGER IN USE</p>
                              <p>Please contact the Mercury & Intelligence Systems Support Team (MISST@justice.gov.uk) to request access to the 
                                prison intelligence applications.</div></p>"))
